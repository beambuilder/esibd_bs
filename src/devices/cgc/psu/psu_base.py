"""PSU (Power Supply Unit) base device class for CGC."""
...
class PSUBase:
    ...
    def __init__(self, com, port, log=None, idn=""):
        ...
        # Get the directory where this file (psu_base.py) is located
        self.class_dir = os.path.dirname(os.path.abspath(__file__))
        
        # Importing dll for hardware control - path relative to psu_base.py
