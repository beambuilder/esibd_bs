...
//                                                                           //
//  CGC Instruments, (c) 2010-2026, Version 1-10. All rights reserved.       //
//                                                                           //
...
int _export COM_ESI_CTRL_GetHVsupplyInterlockEnable (BYTE & InterlockEnable); // Get HV-PSU interlock enable mask
int _export COM_ESI_CTRL_SetHVsupplyInterlockEnable (BYTE   InterlockEnable); // Set HV-PSU interlock enable mask
int _export COM_ESI_CTRL_GetHeatCtrlInterlockEnable (BYTE & InterlockEnable); // Get heat-controller interlock enable mask
int _export COM_ESI_CTRL_SetHeatCtrlInterlockEnable (BYTE   InterlockEnable); // Set heat-controller interlock enable mask
